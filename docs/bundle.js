...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  getTopUser();
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('button').click( () => breakdown() );
...
const getTopUser = () => {
  ...
  .then( data => {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#top-word").text(word);
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#word-count").text(`Count: ${count}`)
  })
}

const breakdown= () => {
  let text = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#input-text').val();
  if (text) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#input-text').val("")
    notify();
  }
}
...
const notify= () => {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('button').text("Success!");
  setTimeout( () => {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('button').text("Break down");
  }, 2000);
